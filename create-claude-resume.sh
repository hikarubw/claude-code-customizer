...
echo ""
echo "📥 To install:"
echo -e "   ${BLUE}cd $OUTPUT_DIR && ./install.sh${NC}"
echo ""
echo "Or manually:"
echo -e "   ${BLUE}code --install-extension $OUTPUT_DIR/claude-code-resume-${VERSION}.vsix${NC}"
echo -e "   ${BLUE}cursor --install-extension $OUTPUT_DIR/claude-code-resume-${VERSION}.vsix${NC}"
echo ""